...
import 'package:project_guard/chat/peer_user_model.dart';
            ...
            children: [
              Container(
                ...
                child: TabBar(
                  ...
                  unselectedLabelColor: kAccentColor2,
                                ...
                                child: StreamBuilder<QuerySnapshot>(
                                  ...
                                  builder: (BuildContext context,
                                    ...
                                    if (snapshot.connectionState == ConnectionState.waiting) {
                                      return Center(
                                        child: CircularProgressIndicator(color: kAccentColor2,),
                                      );
                                    }
        ...
        child: FutureBuilder<List<PeerUser>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting)
            {
              ...
              //return Center(child: CircularProgressIndicator(color: kAccentColor2));
                              ...
                              children: [
                                ...
                                FutureBuilder<bool>(
                                  ...
                                  builder: (context, snapshots1)
                                  {
                                    ...
                                    {
                                      return CircularProgressIndicator(color: kAccentColor2);
                                    }
